...
use ZanySoft\LaravelTheme\Commands\createTheme;
use ZanySoft\LaravelTheme\Commands\installPackage;
use ZanySoft\LaravelTheme\Commands\listThemes;
use ZanySoft\LaravelTheme\Commands\refreshCache;
use ZanySoft\LaravelTheme\Commands\removeTheme;
...
class ThemeServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('zanysoft.themes', function () {
            return new Themes();
        });
    ...
    public function boot()
    {
        ...
        $themes = $this->app->make('zanysoft.themes');
        $themes->scanThemes();
